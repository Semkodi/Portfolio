    ...
    return (
        <section className="text-center py-24 px-4" aria-labelledby="contact-title">
            <ScrollEnthuellung richtung="oben">
                <div className="glass p-6 sm:p-10 md:p-16 w-full max-w-3xl mx-auto rounded-3xl border border-white/10 shadow-2xl relative z-10">
                    <h2 id="contact-title" className="text-2xl sm:text-4xl md:text-5xl font-extrabold mb-6 tracking-tight leading-tight break-words text-white">
                    ...
                    <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-4 md:gap-6">
                        ...
                        <a
                            ...
                            className="flex items-center justify-center gap-3 glass px-8 py-4 rounded-xl hover:border-primary hover:shadow-lg hover:shadow-primary/5 transition-all text-white border border-white/5 active:scale-95"
